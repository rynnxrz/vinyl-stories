...
// Remove this interface since we're no longer using these props
// interface VinylPlayerProps {
//   isPlaying: boolean;
//   onPlayPause: () => void;
// }

// Remove props since we're getting everything from context now
const VinylPlayer: React.FC = () => {
  const vinylRef = useRef<HTMLDivElement>(null);
  const { currentTime, duration, isPlaying, togglePlayPause } = useAudio(); // Add isPlaying and togglePlayPause here
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mt-8 flex flex-col items-center gap-4">
          <div className="flex items-center gap-6">
            ...
            <button
                onClick={togglePlayPause} // Change this line to use togglePlayPause
